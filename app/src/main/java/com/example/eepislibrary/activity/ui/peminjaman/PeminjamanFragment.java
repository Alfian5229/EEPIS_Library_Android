...
public class PeminjamanFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        PeminjamanViewModel peminjamanViewModel = new ViewModelProvider(this).get(PeminjamanViewModel.class);
        View root = inflater.inflate(R.layout.fragment_peminjaman, container, false);
        final TextView textView = root.findViewById(R.id.text_slideshow);
        peminjamanViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
}
